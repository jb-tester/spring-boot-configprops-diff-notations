...
public class PropsUsingUnderscores {
    ...
    InnerPojo inner_pojo;

    public static class InnerPojo{
        String pojo_prop;

        public String getPojo_prop() {
            return pojo_prop;
        }

        public void setPojo_prop(String pojo_prop) {
            this.pojo_prop = pojo_prop;
        }
    }
    ...
    public InnerPojo getInner_pojo() {
        return inner_pojo;
    }

    public void setInner_pojo(InnerPojo inner_pojo) {
        this.inner_pojo = inner_pojo;
    }
}
